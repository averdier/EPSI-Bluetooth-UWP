...
namespace EPSI_Bluetooth.Controls
{
    ...
    {
        public CustomerModel MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as CustomerModel; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(CustomerModel), typeof(CustomerDetailControl), new PropertyMetadata(null));

        public CustomerControlModel ControlModel { get; private set; }
